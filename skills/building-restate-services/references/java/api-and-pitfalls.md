...
- **API reference (JavaDoc)**: https://restatedev.github.io/sdk-java/javadocs/ — `WebFetch` when you need exact class names, method signatures, or a package not covered above. Useful packages: `dev.restate.sdk`, `dev.restate.sdk.common`, `dev.restate.sdk.annotation`, `dev.restate.sdk.springboot`, `dev.restate.sdk.lambda`, `dev.restate.sdk.http.vertx`, `dev.restate.sdk.testing`, `dev.restate.client`.
- **Source code**: https://github.com/restatedev/sdk-java
